...
extern   Hall   Hall_Three;
  ...
  uint16_t   HallK2=669 ;  	//Offset filter coefficient K2: T/(T+0.05);
	...
	int16_t   init_angle=-8980 ;  //   4对级 42BL电机 13620  霍尔的初始角度  0---65536  0---360度
 ...
 void  ThreeHallPara_init(void )
{
   ...
   Hall_Three.step_angle_error =0;   //  *10  IQ(1/6) /(  x/(60 * 10e6 *Fkg))     10 7374 1824       20 9715 0000       2097152   349525 *6000      60度/(60 000000×0.0001)
   Hall_Three.Poles=4;
   Hall_Three.initial_angle=init_angle;  // 182 = 1 度   -50*182=9100   +78*182 =13620
